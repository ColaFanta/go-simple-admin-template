...
func variantClasses(v Variant) string {
	switch v {
	case VariantOutline:
		return "border-input hover:bg-muted border bg-transparent shadow-xs"
	default:
...
func sizeClasses(s Size) string {
	switch s {
	case SizeSm:
		return "h-8 min-w-8 px-2.5 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5"
	case SizeLg:
		return "h-10 min-w-10 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2"
	default:
...
func Toggle(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if inGroup {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 159, Col: 35}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 160, Col: 29}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 161, Col: 39}
			}
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 166, Col: 12}
			}
		...
		if p.Value != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 170, Col: 34}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 172, Col: 44}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/toggle/toggle.templ`, Line: 1, Col: 0}
		}
