...
import (
	...
	"fantacode/ecomm/internal/app/ui/components/textarea"
...
func InputGroup(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/inputgroup/inputgroup.templ`, Line: 86, Col: 12}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/inputgroup/inputgroup.templ`, Line: 1, Col: 0}
		}
...
func Addon(props ...AddonProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		align := "pl-2 has-[>button]:-ml-1 has-[>kbd]:ml-[-0.15rem] order-first"
		switch p.Align {
		case AlignInlineEnd:
			align = "pr-2 has-[>button]:-mr-1 has-[>kbd]:mr-[-0.15rem] order-last"
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/inputgroup/inputgroup.templ`, Line: 170, Col: 12}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/inputgroup/inputgroup.templ`, Line: 174, Col: 30}
		}
...
func inputGroupButtonClasses(size ButtonSize) string {
	...
	case ButtonSizeIconXs:
		return "size-6 rounded-[calc(var(--radius)-5px)] p-0 has-[>svg]:p-0"
	case ButtonSizeIconSm:
		return "size-8 p-0 has-[>svg]:p-0"
	default:
		return "h-6 gap-1 rounded-[calc(var(--radius)-5px)] px-1.5 [&>svg:not([class*='size-'])]:size-3.5"
	}
}
...
func Text(props ...TextProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/ui/components/inputgroup/inputgroup.templ`, Line: 234, Col: 12}
			}
