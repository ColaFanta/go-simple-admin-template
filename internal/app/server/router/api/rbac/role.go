...
func deleteRole(c fiber.Ctx) error {
	return opera.Do(func() opera.Unit {
		...
		payload.RoleName = opera.Must(url.PathUnescape(payload.RoleName))
		...
		// delete g
		opera.Must(ef.DeleteRole(payload.RoleName))
...
func getRoleDetailData(c fiber.Ctx) error {
	return opera.Do(func() opera.Unit {
		...
		role := rbac.Role{
			...
			Permissions: lo.Map(
				opera.Must(ef.GetImplicitPermissionsForUser(payload.RoleName)),
