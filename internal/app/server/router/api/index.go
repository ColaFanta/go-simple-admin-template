...
import (
	...
	"fantacode/ecomm/internal/app/server/router/api/dashboard"
	"fantacode/ecomm/internal/app/server/router/api/inbox"
	"fantacode/ecomm/internal/app/server/router/api/product"
	"fantacode/ecomm/internal/app/server/router/api/rbac"
	"fantacode/ecomm/internal/app/server/router/api/user"
	bizauth "fantacode/ecomm/internal/app/module/auth"
	"strings"
