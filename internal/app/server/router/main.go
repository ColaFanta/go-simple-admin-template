...
import (
	"encoding/json/v2"
	"fantacode/ecomm/internal/app/server/middleware"
	admin "fantacode/ecomm/internal/app/server/router/api"
	"fantacode/ecomm/internal/app/server/router/auth"
...
func New(i do.Injector) *fiber.App {
	...
	cfg.JSONEncoder = func(value any) ([]byte, error) {
		return json.Marshal(value)
	}
	cfg.JSONDecoder = func(data []byte, value any) error {
	...
	app.Use(middleware.Localizer(do.MustInvoke[*i18n.Bundle](i)))
